...
List<Proyek> proyekFromJson(String str) =>
    List<Proyek>.from(json.decode(str).map((x) => Proyek.fromJson(x)));

String proyekToJson(List<Proyek> data) =>
...
class Proyek {
  ...
  factory Proyek.fromJson(Map<String, dynamic> json) => Proyek(
        ...
        listPekerja: List<Pekerja>.from(
            json["listPekerja"].map((x) => Pekerja.fromJson(x))),
