...
Squash Commits: Fungsinya untuk menggabungkan semua commit dalam branch menjadi satu commit tunggal. Ini membantu membuat riwayat commit lebih bersih dan mudah dibaca.
Merge without Squash: Ini menggabungkan semua commit tanpa mengubahnya, jadi commit history akan mempertahankan setiap perubahan individu yang dibuat selama pengembangan.

- Mengapa hanya Squash yang diceklis?

Squash membuat riwayat commit menjadi lebih sederhana dan rapi, terutama untuk fitur atau bug kecil. Dengan Squash, commit tidak dipenuhi oleh banyak commit kecil, yang dapat mempersulit pemahaman riwayat proyek.
...
7. Apa itu DTO? Apakah DTO harus selalu digunakan? Kapan sebaiknya kita menggunakan DTO?
...
11. Pada Tutorial 1 - Panduan bagian Spring Boot > VS Code / IDE > langkah 4, kita mendapati error. Apa penyebabnya? Tip: Kamu bisa melihat commit dengan nama `feat: tutorial 1 - initialize spring boot project` untuk melihat versi kode di langkah tersebut.
